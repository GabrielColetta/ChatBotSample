...
2. The .NET MAUI app need to be compile and deployed before you can use, or you can use the Visual Studio to run the app.
3. You can change the model running on the appsettings.json on the AppHost project and on the Test project. If you change the embeddingModel, it might be required to change the index configuration on the ``MongoDbIndexInitializer``
```json
"LanguageModel": {
    "Model": "gemma3:4b",
